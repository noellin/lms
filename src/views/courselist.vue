					...
					<div class>
						<ul class="site-logo">
							<li class="nav-item">
								<a href="index.html">
									<div class="logo">
										<img
											src="../assets/img/upload/logo_light.png"
											alt
						...
						<ul class="navbar-nav nav-left">
							...
							<li class="nav-item nav-text">
								<a href="collection-list.html">Collection</a>
							</li>
							<li class="nav-item nav-text">
								<a href="teacher-account-list.html">Account</a>
							</li>
						</ul>
					</div>
				</ul>
				<ul class="navbar-nav nav-right">
					<li class="nav-item dropdown">
						<a
							...
							aria-expanded="false"
						>
							<img src="../assets/img/upload/user.png" class="w-40 rounded-circle" alt="Albert Einstein" />
						...
						<div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
							...
							<a class="dropdown-item" href="my-account.html">
								<i class="icon dripicons-user"></i> My account
							</a>
							<a class="dropdown-item" href="#">
								<i class="icon dripicons-lock-open"></i> Log Out
							</a>
						</div>
					</li>
				</ul>
			...
			<div class="content">
				<header class="page-header">
					<div class="d-flex align-items-center">
						...
						<div class="actions top-right mt-2">
							<a href="javascript:history.back()">
								<i class="la la-angle-left text-primary"></i>Back
							</a>
						</div>
					</div>
				</header>
								...
								<div class="form-group form-rounded mb-0">
									<div class="input-group">
										...
										<div class="input-group-append">
											<button class="btn btn-secondary btn-outline btn-icon btn-rounded" type="button">
											...
											<table id="bs4-table" class="table table-striped" style="width:100%">
												...
												<tbody>
													<tr>
														...
														<td>2020/10/30</td>
														<td>
															<button class="btn btn-nostyle" data-toggle="modal" data-target="#editModal">
																<i class="la la-edit"></i>
															</button>
														</td>
														<td>
															<button class="btn btn-primary btn-rounded btn-sm" disabled>Checking</button>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td>
															<button class="btn btn-primary btn-rounded btn-sm btn-message">Checking</button>
														</td>
													</tr>
													<tr>
														<td>
															<a href>302 English</a>
														</td>
														<td>Amanda</td>
														<td>43／50</td>
														<td>Third grage</td>
														<td>
															...
															<span class="badge badge-pill badge-secondary">expiring</span>
														</td>
														<td>
															<button class="btn btn-nostyle" data-toggle="modal" data-target="#editModal">
																<i class="la la-edit"></i>
														...
														<td>
															<button class="btn btn-primary btn-rounded btn-sm">Checking</button>
														</td>
													</tr>
													<tr>
														<td>
											...
											<div class="col-12">
												...
												>
													<ul class="pagination d-flex justify-content-end">
														...
														<li class="paginate_button page-item next" id="recent-transaction-table_next">
															<a
																href="#"
																aria-controls="recent-transaction-table"
																data-dt-idx="4"
					...
					<div class="modal-body">
						...
						<form>
							<div class="form-group row">
								...
								<div class="invalid-feedback">The student is already exists.</div>
							</div>
							<div class="form-group row">
								...
								<div class="invalid-feedback">The number is already exists.</div>
							</div>
						</form>
					</div>
					<div class="modal-footer">
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<p class="mb-0">
							<span class="text-primary">10</span> students
						</p>
					...
					<div class="modal-body">
						...
						<div class="border border-danger rounded mt-4">
							<p class="text-danger ml-3 mt-3 mb-0">
								...
								<br />Would you like to combine datasets?
							</p>
