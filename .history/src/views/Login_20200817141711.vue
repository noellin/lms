<template>
  <div class="login">
    ...
    >
      <strong>Oh snap !</strong> Your email or password is incorrect. please try
      again.
      <button
        type="button"
        class="close"
        ...
        <div class="card">
          <div class="card-body">
            <a
              ...
              class="brand text-center d-block m-b-20 m-t-20"
            >
              <img src="../assets/img/avatars/logo_dark.png" alt="Logo" />
              <!-- <span class="display-4">School Name</span> -->
            </a>
            <p class="text-center m-b-40">iGroup LMS</p>
      ...
      <form class="sign-in-form" action="index.html">
        <div class="card">
          <div class="card-body">
            ...
            <p class="text-primary text-center">E-mail: abc123@gmail.com</p>
